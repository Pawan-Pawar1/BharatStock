            ...
            <div className=" row p-5 mt-5 border-top  text-muted" style={{fontSize:"1.2em", lineHeight:"1.8"}}>
                <div className="col-lg-6 col-md-12 p-5">
                    <p>
                        ...
                        <p>   We named the company Zerodha, a combination of Zero and "Rodha",
                            the Sanskrit word for barrier.

                        Today, our disruptive pricing models and in-house technology have made us 
                        the biggest stock broker in India.</p>
                        <p>
                        Over 1.6+ crore clients place billions 
                        of orders every year through our powerful ecosystem of investment platforms, 
